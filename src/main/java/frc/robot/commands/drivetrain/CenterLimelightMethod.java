...
public class CenterLimelightMethod {
  ...
  private static final Distance offsetReef = Units.Inches.of(7/*Tuning.offsetCenterReef.get()*/);
    public final static List<Integer> reefTags = List.of(6,7,8,9,10,11,17,18,19,20,21,22);
       ...
       */
      public CenterLimelightMethod(Distance offsetX, Distance offsetY, Angle offsetTheta, final List<Integer> tagsToCheck) {
    ...
    public static ChassisSpeeds execute(Distance offsetX, Distance offsetY, Angle offsetTheta, final List<Integer> tagsToCheck, PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid) {
      offsetX = offsetX.plus(Constants.Drivetrain.halfRobotWidthBumpersOn);
      // this.offsetTheta = offsetTheta;
      centerRotaionPid.enableContinuousInput(-Math.PI, Math.PI);
      Pose2d tagPose;
      ...
      Pose2d transformedTagPose = tagPose.transformBy(tagPoseTransform);  // this gets the centerpoint aligned properly; "move" the target
  ...
  public static ChassisSpeeds centerLimelightLeft(PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid){
    return execute(Units.Inches.of(3.85),offsetReef.negate(), Units.Radians.of(0), reefTags, centerPIDx, centerPIDy, centerRotaionPid);
  }
  public static ChassisSpeeds centerLimelightRight(PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid){
    return execute(Units.Inches.of(3.85),offsetReef, Units.Radians.of(0), reefTags,  centerPIDx, centerPIDy, centerRotaionPid);
  }

  public static ChassisSpeeds centerLimelightCenter(PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid){
    return execute(Units.Inches.of(3.85),Units.Inches.of(0), Units.Radians.of(0), reefTags, centerPIDx, centerPIDy, centerRotaionPid);
  }

  public static ChassisSpeeds centerLimeLightPosition(ReefPosition reefPos, PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid) {
    return execute(Units.Inches.of(3.85), offsetReef.times(reefPos.getDirection())/*Units.Inches.of(6.5 * reefPos.getDirection())*/, Units.Radians.of(0), reefPos.getTagID(), centerPIDx, centerPIDy, centerRotaionPid);
  }

  public static ChassisSpeeds centerLimelightHPReverse(PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid, HumanPlayerPosition hpPose) {
    return execute(Units.Inches.of(10), Units.Inches.of(-15), Units.Radians.of(Math.PI), hpPose.getTagID(), centerPIDx, centerPIDy, centerRotaionPid);
  }

  public static ChassisSpeeds centerLimelightClosestHP(PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid, HumanPlayerPosition hpPose) {
    return execute(Units.Inches.of(3.85), Units.Inches.of(-8), Units.Radians.of(Math.PI), List.of(1, 2, 12, 13), centerPIDx, centerPIDy, centerRotaionPid);
  }

  public static ChassisSpeeds centerLimelightProcessor(PIDController centerPIDx, PIDController centerPIDy, PIDController centerRotaionPid, HumanPlayerPosition hpPose) {
    return execute(Units.Inches.of(3.85), Units.Inches.of(-15), Units.Radians.of(0), List.of(3, 16), centerPIDx, centerPIDy, centerRotaionPid);
  }
}
