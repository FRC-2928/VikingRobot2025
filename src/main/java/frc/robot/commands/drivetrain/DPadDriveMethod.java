...
public class DPadDriveMethod {
	...
	public static ChassisSpeeds execute(final Drivetrain drivetrain, ProfiledPIDController absoluteController) {
		final DriverOI oi = RobotContainer.getInstance().driverOI;
		absoluteController.enableContinuousInput(-1, 1);
		final Translation2d translate = translation(oi);
	...
	private static Translation2d translation(DriverOI oi) {
		boolean right = oi.reefMovementRight.getAsBoolean();
		boolean left = oi.reefMovementLeft.getAsBoolean();
