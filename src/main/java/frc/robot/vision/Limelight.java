...
public class Limelight {
	...
	public void setStream(int stream) { this.nt.getEntry("stream").setNumber(stream); }

	public void setPipeline(int pipline) { this.nt.getEntry("pipeline").setNumber(pipline); }
	...
	public int getNumberOfAprilTags() {
		LimelightResults reultsOfJson = LimelightHelpers.getLatestResults(this.limelightName);
